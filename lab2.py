...
def train_model(dataset_root_path, batch_size, number_of_workers, device, optimizer, epochs, print_epochs, download_data, no_batch_norm):
    ...
    Model = model.ResNet18(use_batch_norm = not no_batch_norm).to(device)
    ...
    for epoch in range(epochs):
        ...
        if print_epochs == True:
            ...
            print("Load Time for epoch : ", '%.6f'%(t_load), "sec with", number_of_workers, "workers", " | Train Time : ", '%.6f'%(t_train), "sec")   
